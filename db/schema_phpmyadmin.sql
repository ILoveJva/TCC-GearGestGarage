-- ============================================================
-- Gear Gest Garage - Tabelas (versao para importar no phpMyAdmin)
-- ============================================================
-- COMO USAR NO XAMPP:
--   1) Abra http://localhost/phpmyadmin
--   2) Crie um banco chamado  GearGestGarage  (aba "Bancos de dados")
--   3) Selecione esse banco, va na aba "Importar" e escolha ESTE arquivo
-- (Este arquivo NAO cria o banco; ele assume que voce ja o criou e selecionou.)
-- ============================================================
