...
INSERT INTO catalogo_peca (nome_popular, sistema, vida_util_tempo, vida_util_km)
VALUES
...
INSERT INTO catalogo_servico_peca (id_catalogo_servico, id_catalogo_peca)
VALUES
(1, 1),
(1, 2),
(2, 4),
...
-- Pecas reais (SKU): fabricante, nome tecnico e valor, ligadas ao catalogo
INSERT INTO peca (id_catalogo_peca, nome_tecnico, fabricante, valor, quantidade_estoque)
VALUES
(1, 'OC-90915-YZZE1', 'Fram', 45.00, 5),
(2, '5W30 SN 4L', 'Mobil', 180.00, 5),
(4, 'ARL-3021', 'Tecfil', 90.00, 5),
(75, 'DOT4 500ml', 'Bosch', 60.00, 5),
(71, 'BB-1234', 'Bosch', 220.00, 5),
(73, 'BD-7745 (par)', 'Fremax', 380.00, 5),
(75, 'DOT4 500ml', 'Bosch', 60.00, 5),
(7, 'IFR6T11 (jogo 4un)', 'NGK', 240.00, 5),
(42, 'Injec Clean 300ml', 'Bardahl', 70.00, 5),
(4, 'ARL-4110', 'Tecfil', 110.00, 5),
(59, 'GP-32456 (par)', 'Cofap', 640.00, 5),
(62, 'KB-1102', 'Cofap', 180.00, 5),
(63, 'BS-4409', 'Nakata', 120.00, 5),
(88, 'ALT-14V-90A', 'Bosch', 890.00, 5),
(87, 'M60GD 60Ah', 'Moura', 520.00, 5),
(14, '6PK1120', 'Gates', 130.00, 5),
(80, 'BA-2210', 'Urba', 260.00, 5),
(81, 'VT-88C', 'Wahler', 95.00, 5),
(79, 'Orgânico rosa 1L', 'Paraflu', 70.00, 5),
(83, 'MS-3390', 'Cofap', 85.00, 5),
(1, 'OC-264', 'Fram', 40.00, 5),
(3, '15W40 SL 4L', 'Ipiranga', 150.00, 5),
(5, 'GI-06/7', 'Tecfil', 65.00, 5),
(90, 'H4 12V 60/55W', 'Osram', 35.00, 5),
(47, 'JH-5521', 'Nakata', 310.00, 5),
(48, 'CF-1180', 'Nakata', 85.00, 5),
(54, 'TD-9902', 'Viemar', 140.00, 5),
(46, 'KE-6620', 'Luk', 720.00, 5),
(91, 'CP-8802', 'Denso', 1450.00, 5),
(92, 'R134a 750g', 'Dupont', 120.00, 5),
(10, 'CT-1088', 'Gates', 480.00, 5),
(11, 'TN-5540', 'Gates', 190.00, 5),
(12, 'RT-2214', 'Gates', 160.00, 5),
(1, 'OC-90915-YZZE1', 'Fram', 45.00, 5),
(2, '5W30 SN 4L', 'Mobil', 180.00, 5),
(101, 'SL-4471', 'Tuper', 340.00, 5),
(102, 'CX-1120', 'Borflex', 45.00, 5),
(1, 'OC-90915-YZZE1', 'Fram', 45.00, 5),
(2, '5W30 SN 4L', 'Mobil', 180.00, 5),
(4, 'ARL-3021', 'Tecfil', 90.00, 5),
(5, 'GI-06/7', 'Tecfil', 65.00, 5),
(44, '75W80 GL4 2L', 'Motul', 140.00, 5),
(94, 'MV-7781', 'Bosch', 290.00, 5),
(68, 'CB-4410', 'SKF', 320.00, 5),
(69, 'RL-3308', 'SKF', 280.00, 5);
...
('0002', 1590.00, 'ENTRADA', 'Fábio Nakamura', 'Ruído metálico ao frear e pedal de freio baixo', '2026-03-19', 'APROVADO', 6, 3, 2, 5),
('0003', 1000.00, 'ENTRADA', 'Marcos Vinícius Prado', 'Motor falhando em baixa rotação e consumo elevado', '2026-04-08', 'APROVADO', 8, 5, 3, 4),
('0004', 1910.00, 'ENTRADA', 'Diego Barbosa', 'Barulho na suspensão dianteira ao passar em lombadas', '2026-04-22', 'RECUSADO', 11, 2, 1, 6),
('0005', 2400.00, 'ENTRADA', 'Leandro Souza', 'Veículo não liga pela manhã e luz da bateria acesa no painel', '2026-05-06', 'APROVADO', 14, 7, 4, 7),
('0006', 1410.00, 'ENTRADA', 'Marcos Vinícius Prado', 'Superaquecimento e perda de líquido de arrefecimento', '2026-05-20', 'APROVADO', 17, 8, 5, 4),
('0007', 860.00, 'ENTRADA', 'Fábio Nakamura', 'Revisão geral antes de viagem longa', '2026-06-10', 'APROVADO', 22, 4, 2, 5),
('0008', 1435.00, 'REVISAO', 'Fábio Nakamura', 'Itens reprovados na revisão: coifa rasgada e folga no terminal', '2026-06-12', 'APROVADO', 25, 4, 2, 5),
('0009', 1520.00, 'ENTRADA', 'Diego Barbosa', 'Embreagem patinando em subidas e cheiro de queimado', '2026-06-24', 'APROVADO', 28, 6, 3, 6),
('0010', 2970.00, 'ENTRADA', 'Leandro Souza', 'Ar-condicionado não gela', '2026-07-08', 'RECUSADO', 29, 1, 1, 7),
('0011', 1775.00, 'ENTRADA', 'Marcos Vinícius Prado', 'Troca preventiva da correia dentada aos 120.000 km', '2026-07-22', 'APROVADO', 31, 7, 4, 4),
('0012', 785.00, 'ENTRADA', 'Diego Barbosa', 'Escapamento furado com ruído excessivo', '2026-08-24', 'APROVADO', 36, 8, 5, 6),
('0013', 1220.00, 'ENTRADA', 'Marcos Vinícius Prado', 'Revisão preventiva dos 90.000 km', '2026-08-28', 'APROVADO', 39, 2, 1, 4),
('0014', 890.00, 'ENTRADA', 'Leandro Souza', 'Vidro elétrico do motorista não sobe', '2026-09-01', 'PENDENTE', 43, 7, 4, 7),
('0015', 1220.00, 'ENTRADA', 'Fábio Nakamura', 'Ruído no rolamento da roda dianteira direita', '2026-09-02', 'PENDENTE', 44, 5, 3, 5);
...
INSERT INTO orcamento_peca (id_orcamento, id_peca)
VALUES
(1, 1),
(1, 2),
(1, 3),
...
('0002', 2, 'Substituição do filtro de ar do motor', 'CONCLUIDA', '0h20', '2026-03-06', 3, 1, 8),
('0003', 3, 'Sangria e troca do fluido de freio', 'CONCLUIDA', '0h50', '2026-03-06', 4, 1, 4),
...
('0006', 2, 'Substituição das pastilhas dianteiras', 'CONCLUIDA', '1h10', '2026-03-20', 5, 2, 5),
('0007', 3, 'Substituição dos discos de freio ventilados', 'CONCLUIDA', '1h30', '2026-03-20', 6, 2, 5),
('0008', 4, 'Troca do fluido de freio e sangria do sistema', 'CONCLUIDA', '0h50', '2026-03-20', 7, 2, 8),
('0009', 1, 'Leitura de códigos de falha com scanner', 'CONCLUIDA', '0h40', '2026-04-09', NULL, 3, 4),
('0010', 2, 'Substituição do jogo de velas de ignição', 'CONCLUIDA', '1h20', '2026-04-09', 8, 3, 4),
('0011', 3, 'Limpeza dos bicos injetores em ultrassom', 'CONCLUIDA', '2h00', '2026-04-09', 9, 3, 4),
('0012', 4, 'Substituição do filtro de ar do motor', 'CONCLUIDA', '0h20', '2026-04-09', 10, 3, 8),
('0013', 1, 'Teste de carga do alternador e da bateria', 'CONCLUIDA', '0h50', '2026-05-07', NULL, 4, 7),
('0014', 2, 'Substituição do alternador', 'CONCLUIDA', '2h10', '2026-05-07', 14, 4, 7),
('0015', 3, 'Substituição da correia do alternador', 'CONCLUIDA', '0h40', '2026-05-07', 16, 4, 7),
('0016', 4, 'Substituição da bateria 60Ah', 'CONCLUIDA', '0h20', '2026-05-07', 15, 4, 8),
('0017', 1, 'Teste de pressão do sistema de arrefecimento', 'CONCLUIDA', '0h50', '2026-05-21', NULL, 5, 4),
('0018', 2, 'Substituição da bomba d\'água', 'CONCLUIDA', '2h30', '2026-05-21', 17, 5, 4),
('0019', 3, 'Substituição da válvula termostática', 'CONCLUIDA', '0h50', '2026-05-21', 18, 5, 4),
('0020', 4, 'Substituição da mangueira superior do radiador', 'CONCLUIDA', '0h30', '2026-05-21', 20, 5, 8),
('0021', 5, 'Troca do fluido e sangria do sistema', 'CONCLUIDA', '0h40', '2026-05-21', 19, 5, 8),
('0022', 1, 'Troca do óleo do motor e do filtro de óleo', 'CONCLUIDA', '1h00', '2026-06-11', 21, 6, 5),
('0023', 2, 'Substituição do filtro de combustível', 'CONCLUIDA', '0h40', '2026-06-11', 23, 6, 5),
...
('0027', 6, 'Troca da lâmpada do farol baixo direito', 'CONCLUIDA', '0h20', '2026-06-11', 24, 6, 8),
('0028', 1, 'Substituição da junta homocinética do semi-eixo', 'CONCLUIDA', '2h40', '2026-06-15', 25, 7, 5),
('0029', 2, 'Substituição da coifa de homocinética', 'CONCLUIDA', '1h00', '2026-06-15', 26, 7, 5),
('0030', 3, 'Substituição do terminal de direção', 'CONCLUIDA', '1h10', '2026-06-15', 27, 7, 5),
...
('0033', 2, 'Substituição do kit de embreagem', 'CANCELADA', '', NULL, 28, 8, 6),
('0034', 1, 'Remoção das capas e travamento do motor no PMS', 'CONCLUIDA', '1h20', '2026-07-23', NULL, 9, 4),
('0035', 2, 'Substituição da correia dentada', 'CONCLUIDA', '2h30', '2026-07-23', 31, 9, 4),
('0036', 3, 'Substituição do tensor da correia dentada', 'CONCLUIDA', '0h50', '2026-07-23', 32, 9, 4),
('0037', 4, 'Substituição do rolamento tensionador', 'CONCLUIDA', '0h40', '2026-07-23', 33, 9, 4),
('0038', 5, 'Troca do óleo do motor e do filtro de óleo', 'CONCLUIDA', '1h00', '2026-07-23', 34, 9, 8),
('0039', 1, 'Diagnóstico e remoção do escapamento furado', 'CONCLUIDA', '1h00', '2026-08-26', NULL, 10, 6),
('0040', 2, 'Substituição do coxim do escapamento', 'CONCLUIDA', '0h30', '2026-08-26', 37, 10, 6),
('0041', 3, 'Instalação do silencioso traseiro novo', 'EM_ANDAMENTO', '', NULL, 36, 10, 6),
('0042', 1, 'Troca do óleo do motor e do filtro de óleo', 'PENDENTE', '', NULL, 38, 11, 4),
('0043', 2, 'Substituição do filtro de ar do motor', 'PENDENTE', '', NULL, 40, 11, 4),
('0044', 3, 'Substituição do filtro de combustível', 'PENDENTE', '', NULL, 41, 11, 4),
('0045', 4, 'Troca do óleo da caixa de câmbio manual', 'PENDENTE', '', NULL, 42, 11, 4),
