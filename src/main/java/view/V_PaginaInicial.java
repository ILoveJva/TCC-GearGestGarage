...
public class V_PaginaInicial extends JPanel {
    ...
    // ==========================================
    // SCROLLBAR CUSTOMIZADA E ANIMADA
    // ==========================================

    /**
     * Aplica a UI customizada na barra de rolagem: sem setas, "polegar" fino e arredondado
     * que cresce e fica mais opaco suavemente quando o mouse passa por cima (animação via
     * javax.swing.Timer, sem bibliotecas externas).
     */
    ...
    private static class ScrollBarAnimada extends BasicScrollBarUI {
        // Reaproveita o laranja de destaque já usado nos títulos dos cards — nenhuma cor nova.
